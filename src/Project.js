            ...
            return(
                ...
                <div className='form-head'>
                    ...
                    <div className='form' style={{marginLeft:createfrd+"%"}}>
                        ...
                        <input type="text"  placeholder='Enter Name' value={doremons[1].nameofperson}  className='input' onChange={(e)=>
                        {
                            dynamicdoremon.nameofperson = e.target.value;
